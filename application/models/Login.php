...
class Login extends MY_Controller{
	...
	{
		$this->redirect_login();
		/* Hit following code on submit login form*/
		...
		$this->data["active"] = "login"; /* active class*/
		$this->load->view('headerView', $this->data); /* header view */
		$this->load->view('login/loginView', $this->data); /* Login form view */
		$this->load->view('footerView', $this->data); /* footer view */
	}
	...
	public function forgotten_password()
	{
		...
		'smtp_user' => 'test91172@gmail.com',
		'smtp_pass' => 'developers@dbuglab',
		'smtp_port' => 465,
		);*/
		$message='';
		...
		$this->email->from('test91172@gmail.com', 'Import App');
		$this->email->reply_to('test91172@gmail.com');
