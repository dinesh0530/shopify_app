...
(function($){
	$.fn.picEyes = function(){
		...
		var eyeHtml = '<div class="picshade"></div>'
			...
			//+'<video width="400" controls><source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4"><source src="mov_bbb.ogg" type="video/ogg"></video>'
			+'<img class="aftervideo-pic" src="" />'
			+'<div class="next"></div>'
			+'<div class="prev"></div>'
			+'</div>'
			+'</div>'
		...
		$obj.click(function() {
			...
			if(alt==""){
				//$(this).closest("div.pictures_eyes_in").find("img").css("display","none");
			}else{
				//$(this).closest("div.pictures_eyes_in").find("img").css("display","none");
			}
			...
			$(".pictures_eyes img").attr("alt", alt);
